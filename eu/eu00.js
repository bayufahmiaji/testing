...
function isEU (a){
  var rValue = a == "AT" || a == "BE" || a == "BG" || a == "CY" || a == "HR" || a == "CZ" || a == "DK" || a == "EE" || a == "FI" || a == "FR" || a == "DE" || a == "GR" || a == "HU" || a == "IE" || a == "IT" || a == "LV" || a == "LT" || a == "LU" || a == "MT" || a == "NL" || a == "PL" || a == "PT" || a == "RO" || a == "SK" || a == "SI" || a == "ES" || a == "SE" ||
  //a == "US" ||
  a == "GB";
  return rValue;
}
...
var onMaxSuccess = function(location){
  ...
  if (isEU(sCountryCode)) {
    createCookie("partOfEU","t",365);
    showBanner ();
  }
  else {
    createCookie("partOfEU","f",365);
  }
};
...
else
{
  ...
  s0.async = true;
  s0.src = '//geoip-js.com/js/apis/geoip2/v2.1/geoip2.js';
  var headTag = document.getElementsByTagName('head')[0];
